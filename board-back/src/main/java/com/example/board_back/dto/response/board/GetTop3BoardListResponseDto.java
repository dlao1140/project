...
import com.example.board_back.common.ResponseCode;
import com.example.board_back.common.ResponseMessage;
// import com.example.board_back.dto.object.BoardListItem; // ✨ 기존 import 주석 처리 또는 삭제
import com.example.board_back.dto.response.board.BoardListItemResponseDto; // ✨ 새로운 DTO import
import com.example.board_back.dto.response.ResponseDto;
// import com.example.board_back.entity.BoardListViewEntity; // ✨ 이 DTO에서는 더 이상 직접 사용 안 함
