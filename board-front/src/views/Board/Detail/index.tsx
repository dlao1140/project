...
import { DeleteBoardResponseDto, GetCommentListResponseDto, GetFavoriteLiseResponseDto, IncreaseViewCountResponseDto, PostCommentResponseDto, PutFavoriteResponseDto } from 'apis/response/board';
...
export default function BoardDetail() {
  ...
  const BoardDetailBottom = () => {
    ...
    const getFavoriteListResponse = (responseBody: GetFavoriteLiseResponseDto | ResponseDto | null) => {
      ...
      const {favoriteList} = responseBody as GetFavoriteLiseResponseDto;
